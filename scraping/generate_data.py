...
"""
This script parses the html files inside html/xssed/ and html/randomwalk as
defined respectively in xssed.json and randomwalk.json. It outputs data.csv.
HTML files referenced on randomwalk.json file that cannot be found will be
discarted (because some duplicates can be removed). 
""" 
...
def main():
    ...
    for page in data_rw:
        ...
        features_html = parse_html(page['file_path'])
